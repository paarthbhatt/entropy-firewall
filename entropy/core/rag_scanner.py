"""RAG Shield — document chunk scanner for RAG applications.
...
from entropy.models.schemas import EntropyVerdict, EntropyStatus, ThreatInfo, ThreatLevel
...
class RAGScanner:
    ...
    def __init__(
        self,
        engine: Optional[EntropyEngine] = None,
    ...
    async def scan_chunk(
        ...
        is_malicious, confidence, detections, threat_level = self.pattern_matcher.analyze(content)
