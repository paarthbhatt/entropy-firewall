"""Input Sanitizer ΓÇö recursive multi-layer decoding for obfuscation resistance.
...
Supported decoders (applied in order each iteration):
  1. Unicode normalisation (NFC ΓåÆ NFKC)
  2. HTML entity decoding
  3. URL (percent) decoding
  4. Base64 decoding
  5. Hex-escape decoding  (\\x41 ΓåÆ A)
  6. ROT13
  7. Leetspeak normalisation
  8. Character-split re-joining  (i g n o r e ΓåÆ ignore)
"""
...
class InputSanitizer:
    ...
    def sanitize(self, text: str) -> SanitizedInput:
        ...
        for _depth in range(self.max_depth):
            ...
            # Fixed-point: no more changes ΓåÆ stop
            if decoded == current:
                break
