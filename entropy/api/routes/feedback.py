...
from entropy.services.learning.feedback_store import FeedbackStore, FeedbackRecord
...
class FeedbackRequest(BaseModel):
    ...
    request_log_id: Optional[int] = Field(
        default=None,
...
async def tune_thresholds(
    request: Request,
    auth_record: dict[str, Any] = Depends(require_auth),
    tuner: ThresholdTuner = Depends(get_threshold_tuner),
